...
function Sidebar({
        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                <SheetContent
                    ...
                    data-slot="sidebar"
                    data-mobile="true"
                    className="bg-sidebar text-sidebar-foreground w-(--sidebar-width) h-dvh p-0 [&>button]:hidden"
                    style={{
    ...
    return (
        <div
            className="group peer text-sidebar-foreground hidden md:block md:min-h-svh"
            data-state={state}
